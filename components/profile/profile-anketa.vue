// https://api.hh.ru/areas - Аписка городов
    ...
    >
      ...
      >
        ...
        <v-text-field
          label="Инстаграмм"
          v-model="instagramm"
          :error-messages="instargrammErrors"
          required
          @blur="$v.instagramm.$touch()"
        ></v-text-field>
        <v-text-field
          v-model="slogan"
          :error-messages="sloganErrors"
          label="E-mail"
          required
          @blur="$v.slogan.$touch()"
        ></v-text-field>
...
import { validationMixin } from 'vuelidate'
  ...
  export default {
    ...
    validations: {
      ...
      instagramm: { required, maxLength: maxLength(20) },
